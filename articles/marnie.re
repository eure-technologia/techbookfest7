...
S3 Selectでファイル内走査で最低限も可能になりますし、s3に保管さえしておけば後付でglue crawlerに食わせてathenaで分析する事も
...
TODO: ここにアテナでクエリうってうまーーーな感じの画像でも載せるか
...
クエリの活用例などについてもAWS公式に例がありますので、こちらも参考までに
確認してみてください :)
TODO:(https://docs.aws.amazon.com/ja_jp/athena/latest/ug/waf-logs.html)
